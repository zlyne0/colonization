...
class ColonyWorkerRequestPlanerTest : Savegame1600BaseClass() {
    ...
    fun `should generate list of colonists to buy`() {
        ...
        val transporter = Units.findCarrier(player)
        ...
        // when
        val recomendations = purchaseRecommendations.generateRecommendations(placeCalculator, entryPointTurnRange)
